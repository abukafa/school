    ...
    <div class="album py-2 mt-5">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
                <div class="card shadow-sm">
                    <div style="overflow: hidden;">
                        <img src="<?= base_url() ?>/img/photo/1.jpeg" style="height:300px;" alt="">
                    </div>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <div style="overflow: hidden;">
                        <img src="<?= base_url() ?>/img/photo/2.jpeg" style="height:300px;" alt="">
                    </div>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <div style="overflow: hidden;">
                        <img src="<?= base_url() ?>/img/photo/3.jpeg" style="height:300px;" alt="">
                    </div>
