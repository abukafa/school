...
<img src="<?= base_url() ?>/img/photo/1.jpeg" class="rounded w-100" alt="">
...
<div class="row mt-4">
    <div class="col-md-8">
        <article class="blog-post mx-sm-2 ms-md-2">
            ...
            <p class="blog-post-title">Another blog post</p>
    ...
    <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm h-md-250 position-relative">
            ...
            <div class="col-4 d-none d-lg-block">
                <img class="snd-post" src="<?= base_url() ?>/img/photo/2.jpeg" alt="">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm h-md-250 position-relative">
            ...
            <div class="col-4 d-none d-lg-block">
                <img class="snd-post" src="<?= base_url() ?>/img/photo/3.jpeg" alt="">
            </div>
        </div>
    </div>
</div>
