...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownFilter" data-popper-placement="bottom-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 40px, 0px);">
                ...
                <li><a class="dropdown-item" href="/admin/siswa/<?= tahun(7) ?>">Kelas VII</a></li>
                <li><a class="dropdown-item" href="/admin/siswa/<?= tahun(8) ?>">Kelas VIII</a></li>
                <li><a class="dropdown-item" href="/admin/siswa/<?= tahun(9) ?>">Kelas IX</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" href="/admin/siswa">Semua Data</a></li>
            </ul>
        </div>
    </div>
    <table class="table table-hover mt-5 align-middle">
        <tr>
            ...
            <th>No. Induk</th>
            <th>Nama</th>
            <th class="d-none d-xl-table-cell">Wali</th>
        ...
        foreach ($siswa as $row) : ?>
            <tr>
                ...
                <td><?= $row['ni'] ?></td>
                <td><?= $row['nama'] ?></td>
                <td class="d-none d-xl-table-cell"><?= $row['nama_ayah'] ?></td>
                <td class="d-none d-xl-table-cell"><?= $row['alamat'] ?></td>
                <td class="d-none d-xl-table-cell"><?= kelas($row['tahun']) ?></td>
                <td class="text-end">
