...
<head>
    ...
    <meta name="supported" content="Semangkamedia">
...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="navbars">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link<?= $title == 'Profil' ? ' active' : '' ?> dropdown-toggle" href="" id="drop-profil" data-bs-toggle="dropdown" aria-expanded="false">Profil</a>
                                <ul class="dropdown-menu" aria-labelledby="drop-profil">
                                    <li><a class="dropdown-item" href="/profil">Profil Sekolah</a></li>
                                    <li><a class="dropdown-item" href="/prakata">Prakata Kepala Sekolah</a></li>
                                    <li><a class="dropdown-item" href="/program">Program Unggulan</a></li>
                                    <li><a class="dropdown-item" href="/pengajar">Staff Pengajar</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link<?= $title == 'Informasi' ? ' active' : '' ?> dropdown-toggle" href="" id="drop-info" data-bs-toggle="dropdown" aria-expanded="false">Informasi</a>
                                <ul class="dropdown-menu" aria-labelledby="drop-info">
                                    <li><a class="dropdown-item" href="/kalender">Kalender Pendidikan</a></li>
                                    <li><a class="dropdown-item" href="/jadwal">Jadwal Pelajaran</a></li>
                                    <li><a class="dropdown-item" href="/absensi">Absensi</a></li>
                                    <li><a class="dropdown-item" href="/info">Pengumuman</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
    ...
    <main>
        ...
        <!-- FOOTER -->
        <div class="container">
            <div class="footer bg-success text-light mt-4 p-4">
